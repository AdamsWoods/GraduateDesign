package com.example.news.search.adapters;
...
import com.example.news.search.OnItemClickListener;
import com.example.news.search.OnItemDeleteListener;
...
public class ContentAdapter2 extends RecyclerView.Adapter<ContentAdapter2.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.search_item2, parent, false);
