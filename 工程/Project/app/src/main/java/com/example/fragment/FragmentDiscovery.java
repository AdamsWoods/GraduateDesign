...
import com.example.DiscoveryDetailsActivity;
import com.example.OnItemClickListener;
import com.example.R;
import com.example.adapter.DiscoveryListAdapter;
import com.example.bean.DiscoveryItem;
...
//        //点击监听
    ...
    public void getData() {
        if (flag == 0){
            for (int i = 0; i < 20; i++) {
                //手写假的数据
                DiscoveryItem item = new DiscoveryItem("德邦2018战略发布会在京举行，承诺将每一份大件快递送货上门",
